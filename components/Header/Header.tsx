...
const Header: React.FC<HeaderProps> = () => {
  ...
  return (
    <header>
      <nav className="fixed w-full md:p-7 p-5 flex justify-between">
        ...
        {/* Mobile Nav */}
        <ul className={`md:hidden absolute left-0 bg-white w-full h-full bottom-0 py-24 duration-500 ${open ? "top-0" : "top-[-100%]"}`}>
            <NavLinks />
        </ul>
